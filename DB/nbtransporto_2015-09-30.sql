...
# Generation Time: 2015-10-01 02:36:29 +0000
# ************************************************************
...
VALUES
	('nabu','S.I. Empresas de Transporte');
...
VALUES
	('addcustomer','ndb_address_tbl','nb_add_celular_fld','nb_add_celular_fld'),
	('addcustomer','ndb_address_tbl','nb_add_city_fld','nb_add_city_fld'),
	('addcustomer','ndb_address_tbl','nb_add_direccion_fld','nb_add_direccion_fld'),
	('addcustomer','ndb_address_tbl','nb_add_email_fld','nb_add_email_fld'),
	('addcustomer','ndb_address_tbl','nb_add_telefono_fld','nb_add_telefono_fld'),
	('addcustomer','ndb_address_tbl','nb_state_fld','nb_state_fld'),
	('addcustomer','ndb_customer_tbl','nb_observaciones_fld','nb_observaciones_fld'),
	('addcustomer','ndb_customer_tbl','nd_estado_fld','nd_estado_fld'),
	('addcustomer','ndb_person_tbl','nbd_person_tipo_fld','nbd_person_tipo_fld'),
	('addcustomer','ndb_person_tbl','nb_ciudadexp_fld','nb_ciudadexp_fld'),
	('addcustomer','ndb_person_tbl','nb_fechaexp_fld','nb_fechaexp_fld'),
	('addcustomer','ndb_person_tbl','nb_fechanac_fld','nb_fechanac_fld'),
	('addcustomer','ndb_person_tbl','nb_nombre_fld','nb_nombre_fld'),
	('addcustomer','ndb_person_tbl','nb_numerodoc_fld','nb_numerodoc_fld'),
	('addcustomer','ndb_person_tbl','nb_rlegal_fld','nb_rlegal_fld'),
	('addcustomer','ndb_person_tbl','nb_sexo_fld','nb_sexo_fld'),
	('addcustomer','ndb_person_tbl','nb_tipodoc_fld','nb_tipodoc_fld');
...
VALUES
	...
	('addcustomer','nb_add_date_fld',10,'true'),
	...
	('addcustomer','nb_add_user_fld',10,'true'),
	...
	('addcustomer','nb_mdf_date_fld',10,'true'),
	...
	('addcustomer','nb_mdf_user_fld',10,'true'),
...
VALUES
	...
	('srccustomer',5,2,3,'Modificar Cliente',NULL,'fa fa-pencil-square-o','N'),
	('srccustomer',6,0,3,'Transporte',NULL,'fa fa-road','N'),
	('srccustomer',7,6,1,'Vehiculos',NULL,'fa fa-bus','N'),
	('srccustomer',8,7,1,'Consultar Vehiculos',NULL,'fa fa-search','N'),
	('srccustomer',9,7,2,'Ingresar Vehiculos',NULL,'fa fa-plus-circle','N'),
	('srccustomer',10,7,3,'Modificar Vehiculos',NULL,'fa fa-pencil-square-o','N'),
	('srccustomer',11,6,2,'Propietarios',NULL,'fa fa-male','N'),
	('srccustomer',12,11,1,'Consultar Propietarios',NULL,'fa fa-search','N'),
	('srccustomer',13,11,2,'Ingresar Propietarios',NULL,'fa fa-plus-circle','N'),
	('srccustomer',14,11,3,'Modificar Propietarios',NULL,'fa fa-pencil-square-o','N'),
	('srccustomer',15,6,3,'Conductores',NULL,'fa fa-users','N'),
	('srccustomer',16,15,1,'Consultar Conductores',NULL,'fa fa-search','N'),
	('srccustomer',17,15,2,'Ingresar Conductor',NULL,'fa fa-plus-circle','N'),
	('srccustomer',18,15,3,'Modificar Conductor',NULL,'fa fa-pencil-square-o','N'),
	('srccustomer',19,6,4,'Mantenimiento',NULL,'fa fa-wrench','N'),
	('srccustomer',20,19,1,'Consultar Mantenimiento',NULL,'fa fa-search','N'),
	('srccustomer',21,19,2,'Ingresar Mantenimiento',NULL,'fa fa-plus-circle','N'),
	('srccustomer',22,19,3,'Modificar Mantenimiento',NULL,'fa fa-pencil-square-o','N'),
	('srccustomer',23,6,5,'Documentacion',NULL,'fa fa-file-text-o','N'),
	('srccustomer',24,23,1,'Consultar Documentos',NULL,'fa fa-search','N'),
	('srccustomer',25,23,2,'Ingresar Documentos',NULL,'fa fa-plus-circle','N'),
	('srccustomer',26,23,3,'Modificar Documentos',NULL,'fa fa-pencil-square-o','N'),
	('srccustomer',31,0,4,'Planillas',NULL,'fa fa-book','N'),
	('srccustomer',32,31,1,'Contratos',NULL,'fa fa-file','N'),
	('srccustomer',33,32,1,'Consultar Contratos',NULL,'fa fa-search','N'),
	('srccustomer',34,32,2,'Ingresar Contratos',NULL,'fa fa-plus-circle','N'),
	('srccustomer',35,32,3,'Modificar Contratos',NULL,'fa fa-pencil-square-o','N'),
	('srccustomer',36,31,2,'FUEC',NULL,'fa fa-newspaper-o','N'),
	('srccustomer',37,36,1,'Consultar FUEC',NULL,'fa fa-search','N'),
	('srccustomer',38,36,2,'Ingresar FUEC',NULL,'fa fa-plus-circle','N'),
	('srccustomer',39,36,3,'Modificar FUEC',NULL,'fa fa-pencil-square-o','N'),
	('srccustomer',40,0,5,'Ayuda',NULL,'fa fa-life-buoy','N'),
	('srccustomer',41,0,6,'Cerrar sesion','login','fa fa-sign-out','N');
...
VALUES
	...
	('srccustomer','Busqueda Cliente','dataGrids','datagrid','false');
...
INSERT INTO `nb_table_fields_tbl` (`nb_id_fld`, `nb_id_table_fld`, `nb_type_fld`, `nb_long_fld`, `nb_is_null_fld`, `nb_description_fld`)
VALUES
	('nbd_person_tipo_fld','ndb_person_tbl','number',NULL,NULL,NULL),
	('nb_add_celular_fld','ndb_address_tbl','string',NULL,NULL,NULL),
	('nb_add_city_fld','ndb_address_tbl','string',NULL,NULL,NULL),
	('nb_add_direccion_fld','ndb_address_tbl','string',NULL,NULL,NULL),
	('nb_add_email_fld','ndb_address_tbl','string',NULL,NULL,NULL),
	('nb_add_telefono_fld','ndb_address_tbl','string',NULL,NULL,NULL),
	('nb_ciudadexp_fld','ndb_person_tbl','string',NULL,NULL,NULL),
	('nb_fechaexp_fld','ndb_person_tbl','date',NULL,NULL,NULL),
	('nb_fechanac_fld','ndb_person_tbl','date',NULL,NULL,NULL),
	('nb_nombre_fld','ndb_person_tbl','string',NULL,NULL,NULL),
	('nb_numerodoc_fld','ndb_person_tbl','string',NULL,NULL,NULL),
	('nb_observaciones_fld','ndb_customer_tbl','string',NULL,NULL,NULL),
	('nb_rlegal_fld','ndb_person_tbl','string',NULL,NULL,NULL),
	('nb_sexo_fld','ndb_person_tbl','string',NULL,NULL,NULL),
	('nb_state_fld','ndb_address_tbl','string',NULL,NULL,NULL),
	('nb_tipodoc_fld','ndb_person_tbl','string',NULL,NULL,NULL),
	('nd_estado_fld','ndb_customer_tbl','string',NULL,NULL,NULL);
...
VALUES
	...
	('nb_sexo_fld','F','Femenino'),
	('nb_sexo_fld','M','Masculino');
...
VALUES
	...
	(15,'addcustomer','nb_estado_fld',3,1),
	(16,'addcustomer','nb_observaciones_fld',3,2),
	(17,'addcustomer','nb_add_user_fld',4,1),
	(18,'addcustomer','nb_add_date_fld',4,2),
	(19,'addcustomer','nb_mdf_user_fld',4,3),
	(20,'addcustomer','nb_mdf_date_fld',4,4);
...
VALUES
	...
	(4,'addcustomer','4- Control','Informacion de Auditoria');
...
VALUES
	(1,'76','76001','Calle 21 N numero 9A-105 Apt 202','2252611','3012657760','carlosgc4@gmail.com');
...
VALUES
	(1,'1',X'436C69656E746520646520507275656261','NABU','2015-09-10 14:41:34','NABU','2015-09-10 14:41:44');
...
VALUES
	(1,NULL,'1','14800275','Tulua','2001-11-09','M','Carlos Alberto Garcia Cobo','1984-04-04',NULL);
